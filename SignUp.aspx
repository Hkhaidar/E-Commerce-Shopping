    ...
    <form id="form1" runat="server">
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="Default.aspx"><span>
                            <img alt="Logo" src="Images/weblogo.png" height="30" /></span>LovelyShopping</a>
                    </div>
        ...
        <div class="center-page">
            ...
            <div class="col-xs-11 space-vert">
                <asp:Button ID="btSignup" runat="server" Class="btn btn-success" Text="Sign Up" OnClick="btSignup_Click" ClientIDMode="Predictable" />
                <asp:Label ID="lblMsg" runat="server"></asp:Label>
            </div>

            <div class="col-xs-11 space-vert">
                <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Sign Up" OnClick="btSignup_Click1" />
            </div>
        ...
        <footer class="footer-pos">
            <div class="container">
                ...
                <p>&copy; 2020 mylovelyshopping.com &middot; <a href="Default.aspx">Home</a> &middot; <a href="#">About</a> &middot; <a href="#">Contact</a> &middot; <a href="#">Products</a></p>
            </div>
        </footer>
