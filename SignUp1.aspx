    ...
    <form id="form1" runat="server">
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="Default.aspx"><span>
                            <img alt="Logo" src="Images/weblogo.png" height="30" /></span>AgrOnline</a>
                    </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-header">Fresh Fruits & Vegetables</li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="#">Fruits & Fructose</a></li>
                                    <li><a href="#">Fresh Vegetable</a></li>
                                    
                                    <li role="separator" class="divider"></li>
                                    <li class="dropdown-header">Dry fruits</li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="#">Nuts</a></li>
                                    <li><a href="#">Cashew nut</a></li>
                        
                                    <li role="separator" class="divider"></li>
                                    <li class="dropdown-header">Oils</li>
                                    <li role="separator" class="divider"></li>
                                    <li><a href="#">Top Branded oils</a></li>
        ...
        <footer class="footer-pos">
            <div class="container">
                ...
                <p>&copy; 2020 myAgrOnline.com &middot; <a href="Default.aspx">Home</a> &middot; <a href="#">About</a> &middot; <a href="#">Contact</a> &middot; <a href="#">Products</a></p>
            </div>
        </footer>
